...
function setCookie() {
    ...
    return res.json201(cookie, message).cookie(clave, valor);
...
function deleteCookie() {
    ...
    res.json200(null, message).clearCookie(clave);
...
function setCookieSigned() {
    ...
    const { clave, valor } = req.body;
    const cookie = { clave, valor };
    res.json200(cookie, message).cookie(clave, valor, { signed: true });
